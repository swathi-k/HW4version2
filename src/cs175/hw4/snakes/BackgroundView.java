...
public class BackgroundView extends View {
    ...
    public BackgroundView(Context context, AttributeSet attrs) {
        ...
        mColors[0] = a.getColor(R.styleable.BackgroundView_colorSegmentOne, Color.BLACK);
        mColors[1] = a.getColor(R.styleable.BackgroundView_colorSegmentTwo, Color.BLACK);
        mColors[2] = a.getColor(R.styleable.BackgroundView_colorSegmentThree, Color.BLACK);
        mColors[3] = a.getColor(R.styleable.BackgroundView_colorSegmentFour, Color.BLACK);
